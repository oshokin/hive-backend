...
Запущено 2 потока, которые просканировали таблицу по частям, в каждой из которых, откинули по 333 333 записей. \
...
```
Выбрал составной индекс, поскольку в запросе, который используется в API идет одновременный поиск по имени и фамилии.\
